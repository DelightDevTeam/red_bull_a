    ...
    <div class="col-12 col-md-8 mx-auto">
      <div class="card">
        ...
        <div class="card-header pb-0">
          <div class="d-lg-flex">
            <div>
              <h5 class="mb-0">@lang('public.create_new_player')
              </h5>
        ...
        <div class="card-body">
          <form role="form" method="POST" class="text-start" action="{{ route('admin.player.store') }}">
            ...
            <div class="custom-form-group">
              <label for="title">@lang('public.player_name') <span class="text-danger">*</span></label>
            ...
            <div class="custom-form-group">
              <label for="title">@lang('public.amount')Amount</label>
            ...
            <div class="custom-form-group">
              <button class="btn btn-info" type="button" id="resetFormButton">@lang('public.reset')</button>
