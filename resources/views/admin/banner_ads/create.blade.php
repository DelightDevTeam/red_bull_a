  ...
  <div class="col-12">
    <div class="container mb-3">
      <a class="btn btn-icon btn-2 btn-primary float-end me-5" href="{{ route('admin.adsbanners.index') }}">
        <span class="btn-inner--icon mt-1"><i class="material-icons">arrow_back</i>@lang('public.create')</span>
      </a>
    </div>
          ...
          <div class="card z-index-0 fadeIn3 fadeInBottom">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg py-2 pe-1">
                <h4 class="text-white font-weight-bolder text-center mb-2">@lang('public.new_ads_banner_create')</h4>
              </div>
            </div>
            <div class="card-body">
              <form role="form" class="text-start" action="{{ route('admin.adsbanners.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="custom-form-group">
                  <label for="title">@lang('public.ads_banner_image')/label>
